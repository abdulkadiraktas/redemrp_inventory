...
function createObjectBox(object) {
  ...
  boxContent.setAttribute('onmouseover', "Over(`" + object.label + "`, `" + object.description + "`," + JSON.stringify(object.meta) + "," + JSON.stringify(object.weight) + ")    ");
...
function Over(item, desc, meta, weight) {
